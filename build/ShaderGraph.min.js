...
a.source&&d.global==a.global&&d.multiline==a.multiline&&d.ignoreCase==a.ignoreCase}if("object"!=typeof d||"object"!=typeof a)return!1;for(var e=j.length;e--;)if(j[e]==d)return!0;j.push(d);var e=0,q=!0;if("[object Array]"==b){if(e=d.length,q=e==a.length)for(;e--&&(q=e in d==e in a&&f(d[e],a[e],j)););}else{if("constructor"in d!="constructor"in a||d.constructor!=a.constructor)return!1;for(var g in d)if(c.has(d,g)&&(e++,!(q=c.has(a,g)&&f(d[g],a[g],j))))break;if(q){for(g in a)if(c.has(a,g)&&!e--)break;
q=!e}}j.pop();return q}var a=this,b=a._,e={},h=Array.prototype,i=Object.prototype,g=h.slice,m=h.unshift,k=i.toString,n=i.hasOwnProperty,s=h.forEach,z=h.map,A=h.reduce,B=h.reduceRight,C=h.filter,D=h.every,E=h.some,t=h.indexOf,F=h.lastIndexOf,i=Array.isArray,I=Object.keys,u=Function.prototype.bind,c=function(d){return new p(d)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=c),exports._=c):a._=c;c.VERSION="1.3.3";var l=c.each=c.forEach=function(d,
a,j){if(null!=d)if(s&&d.forEach===s)d.forEach(a,j);else if(d.length===+d.length)for(var b=0,f=d.length;b<f&&!(b in d&&a.call(j,d[b],b,d)===e);b++);else for(b in d)if(c.has(d,b)&&a.call(j,d[b],b,d)===e)break};c.map=c.collect=function(d,a,c){var b=[];if(null==d)return b;if(z&&d.map===z)return d.map(a,c);l(d,function(d,e,f){b[b.length]=a.call(c,d,e,f)});d.length===+d.length&&(b.length=d.length);return b};c.reduce=c.foldl=c.inject=function(d,a,j,b){var e=2<arguments.length;null==d&&(d=[]);if(A&&d.reduce===
A)return b&&(a=c.bind(a,b)),e?d.reduce(a,j):d.reduce(a);l(d,function(d,c,f){e?j=a.call(b,j,d,c,f):(j=d,e=!0)});if(!e)throw new TypeError("Reduce of empty array with no initial value");return j};c.reduceRight=c.foldr=function(d,a,j,b){var e=2<arguments.length;null==d&&(d=[]);if(B&&d.reduceRight===B)return b&&(a=c.bind(a,b)),e?d.reduceRight(a,j):d.reduceRight(a);var f=c.toArray(d).reverse();b&&!e&&(a=c.bind(a,b));return e?c.reduce(f,a,j,b):c.reduce(f,a)};c.find=c.detect=function(d,a,c){var b;G(d,function(d,
e,f){if(a.call(c,d,e,f))return b=d,!0});return b};c.filter=c.select=function(d,a,c){var b=[];if(null==d)return b;if(C&&d.filter===C)return d.filter(a,c);l(d,function(d,e,f){a.call(c,d,e,f)&&(b[b.length]=d)});return b};c.reject=function(d,a,c){var b=[];if(null==d)return b;l(d,function(d,e,f){a.call(c,d,e,f)||(b[b.length]=d)});return b};c.every=c.all=function(d,a,c){var b=!0;if(null==d)return b;if(D&&d.every===D)return d.every(a,c);l(d,function(d,f,g){if(!(b=b&&a.call(c,d,f,g)))return e});return!!b};
var G=c.some=c.any=function(d,a,b){a||(a=c.identity);var f=!1;if(null==d)return f;if(E&&d.some===E)return d.some(a,b);l(d,function(d,c,g){if(f||(f=a.call(b,d,c,g)))return e});return!!f};c.include=c.contains=function(d,a){return null==d?!1:t&&d.indexOf===t?-1!=d.indexOf(a):G(d,function(d){return d===a})};c.invoke=function(d,a){var b=g.call(arguments,2);return c.map(d,function(d){return(c.isFunction(a)?a||d:d[a]).apply(d,b)})};c.pluck=function(d,a){return c.map(d,function(d){return d[a]})};c.max=function(d,
a,b){if(!a&&c.isArray(d)&&d[0]===+d[0])return Math.max.apply(Math,d);if(!a&&c.isEmpty(d))return-Infinity;var e={computed:-Infinity};l(d,function(d,c,f){c=a?a.call(b,d,c,f):d;c>=e.computed&&(e={value:d,computed:c})});return e.value};c.min=function(d,a,b){if(!a&&c.isArray(d)&&d[0]===+d[0])return Math.min.apply(Math,d);if(!a&&c.isEmpty(d))return Infinity;var e={computed:Infinity};l(d,function(d,c,f){c=a?a.call(b,d,c,f):d;c<e.computed&&(e={value:d,computed:c})});return e.value};c.shuffle=function(d){var a=
[],c;l(d,function(d,b){c=Math.floor(Math.random()*(b+1));a[b]=a[c];a[c]=d});return a};c.sortBy=function(d,a,b){var e=c.isFunction(a)?a:function(d){return d[a]};return c.pluck(c.map(d,function(d,a,c){return{value:d,criteria:e.call(b,d,a,c)}}).sort(function(d,a){var c=d.criteria,b=a.criteria;return void 0===c?1:void 0===b?-1:c<b?-1:c>b?1:0}),"value")};c.groupBy=function(d,a){var b={},e=c.isFunction(a)?a:function(d){return d[a]};l(d,function(d,a){var c=e(d,a);(b[c]||(b[c]=[])).push(d)});return b};c.sortedIndex=
...
g.call(d,Math.max(d.length-a,0)):d[d.length-1]};c.rest=c.tail=function(d,a,c){return g.call(d,null==a||c?1:a)};c.compact=function(d){return c.filter(d,function(d){return!!d})};c.flatten=function(d,a){return c.reduce(d,function(d,b){if(c.isArray(b))return d.concat(a?b:c.flatten(b));d[d.length]=b;return d},[])};c.without=function(d){return c.difference(d,g.call(arguments,1))};c.uniq=c.unique=function(d,a,b){var b=b?c.map(d,b):d,e=[];3>d.length&&(a=!0);c.reduce(b,function(b,j,f){if(a?c.last(b)!==j||
!b.length:!c.include(b,j))b.push(j),e.push(d[f]);return b},[]);return e};c.union=function(){return c.uniq(c.flatten(arguments,!0))};c.intersection=c.intersect=function(d){var a=g.call(arguments,1);return c.filter(c.uniq(d),function(d){return c.every(a,function(a){return 0<=c.indexOf(a,d)})})};c.difference=function(d){var a=c.flatten(g.call(arguments,1),!0);return c.filter(d,function(d){return!c.include(a,d)})};c.zip=function(){for(var d=g.call(arguments),a=c.max(c.pluck(d,"length")),b=Array(a),e=
0;e<a;e++)b[e]=c.pluck(d,""+e);return b};c.indexOf=function(d,a,b){if(null==d)return-1;var e;if(b)return b=c.sortedIndex(d,a),d[b]===a?b:-1;if(t&&d.indexOf===t)return d.indexOf(a);b=0;for(e=d.length;b<e;b++)if(b in d&&d[b]===a)return b;return-1};c.lastIndexOf=function(d,a){if(null==d)return-1;if(F&&d.lastIndexOf===F)return d.lastIndexOf(a);for(var c=d.length;c--;)if(c in d&&d[c]===a)return c;return-1};c.range=function(d,a,c){1>=arguments.length&&(a=d||0,d=0);for(var c=arguments[2]||1,b=Math.max(Math.ceil((a-
d)/c),0),e=0,f=Array(b);e<b;)f[e++]=d,d+=c;return f};var H=function(){};c.bind=function(d,a){var b,e;if(d.bind===u&&u)return u.apply(d,g.call(arguments,1));if(!c.isFunction(d))throw new TypeError;e=g.call(arguments,2);return b=function(){if(!(this instanceof b))return d.apply(a,e.concat(g.call(arguments)));H.prototype=d.prototype;var c=new H,f=d.apply(c,e.concat(g.call(arguments)));return Object(f)===f?f:c}};c.bindAll=function(d){var a=g.call(arguments,1);0==a.length&&(a=c.functions(d));l(a,function(a){d[a]=
c.bind(d[a],d)});return d};c.memoize=function(d,a){var b={};a||(a=c.identity);return function(){var e=a.apply(this,arguments);return c.has(b,e)?b[e]:b[e]=d.apply(this,arguments)}};c.delay=function(a,c){var b=g.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},c)};c.defer=function(a){return c.delay.apply(c,[a,1].concat(g.call(arguments,1)))};c.throttle=function(a,b){var e,f,g,h,k,i,n=c.debounce(function(){k=h=!1},b);return function(){e=this;f=arguments;g||(g=setTimeout(function(){g=
null;k&&a.apply(e,f);n()},b));h?k=!0:i=a.apply(e,f);n();h=!0;return i}};c.debounce=function(a,c,b){var e;return function(){var f=this,g=arguments;b&&!e&&a.apply(f,g);clearTimeout(e);e=setTimeout(function(){e=null;b||a.apply(f,g)},c)}};c.once=function(a){var c=!1,b;return function(){if(c)return b;c=!0;return b=a.apply(this,arguments)}};c.wrap=function(a,c){return function(){var b=[a].concat(g.call(arguments,0));return c.apply(this,b)}};c.compose=function(){var a=arguments;return function(){for(var c=
arguments,b=a.length-1;0<=b;b--)c=[a[b].apply(this,c)];return c[0]}};c.after=function(a,c){return 0>=a?c():function(){if(1>--a)return c.apply(this,arguments)}};c.keys=I||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],e;for(e in a)c.has(a,e)&&(b[b.length]=e);return b};c.values=function(a){return c.map(a,c.identity)};c.functions=c.methods=function(a){var b=[],e;for(e in a)c.isFunction(a[e])&&b.push(e);return b.sort()};c.extend=function(a){l(g.call(arguments,1),function(b){for(var c in b)a[c]=
b[c]});return a};c.pick=function(a){var b={};l(c.flatten(g.call(arguments,1)),function(c){c in a&&(b[c]=a[c])});return b};c.defaults=function(a){l(g.call(arguments,1),function(c){for(var b in c)null==a[b]&&(a[b]=c[b])});return a};c.clone=function(a){return!c.isObject(a)?a:c.isArray(a)?a.slice():c.extend({},a)};c.tap=function(a,b){b(a);return a};c.isEqual=function(a,b){return f(a,b,[])};c.isEmpty=function(a){if(null==a)return!0;if(c.isArray(a)||c.isString(a))return 0===a.length;for(var b in a)if(c.has(a,
...
k.call(a)};c.isFinite=function(a){return c.isNumber(a)&&isFinite(a)};c.isNaN=function(a){return a!==a};c.isBoolean=function(a){return!0===a||!1===a||"[object Boolean]"==k.call(a)};c.isDate=function(a){return"[object Date]"==k.call(a)};c.isRegExp=function(a){return"[object RegExp]"==k.call(a)};c.isNull=function(a){return null===a};c.isUndefined=function(a){return void 0===a};c.has=function(a,b){return n.call(a,b)};c.noConflict=function(){a._=b;return this};c.identity=function(a){return a};c.times=
function(a,b,c){for(var e=0;e<a;e++)b.call(c,e)};c.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};c.result=function(a,b){if(null==a)return null;var e=a[b];return c.isFunction(e)?e.call(a):e};c.mixin=function(a){l(c.functions(a),function(b){var e=c[b]=a[b];p.prototype[b]=function(){var a=g.call(arguments);m.call(a,this._wrapped);return v(e.apply(c,a),this._chain)}})};var J=0;c.uniqueId=
function(a){var b=J++;return a?a+b:b};c.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var w=/.^/,r={"\\":"\\","'":"'",r:"\r",n:"\n",t:"\t",u2028:"\u2028",u2029:"\u2029"},x;for(x in r)r[r[x]]=x;var K=/\\|'|\r|\n|\t|\u2028|\u2029/g,L=/\\(\\|'|r|n|t|u2028|u2029)/g,y=function(a){return a.replace(L,function(a,b){return r[b]})};c.template=function(a,b,e){e=c.defaults(e||{},c.templateSettings);a="__p+='"+a.replace(K,function(a){return"\\"+r[a]}).replace(e.escape||
w,function(a,b){return"'+\n_.escape("+y(b)+")+\n'"}).replace(e.interpolate||w,function(a,b){return"'+\n("+y(b)+")+\n'"}).replace(e.evaluate||w,function(a,b){return"';\n"+y(b)+"\n;__p+='"})+"';\n";e.variable||(a="with(obj||{}){\n"+a+"}\n");var a="var __p='';var print=function(){__p+=Array.prototype.join.call(arguments, '')};\n"+a+"return __p;\n",f=new Function(e.variable||"obj","_",a);if(b)return f(b,c);b=function(a){return f.call(this,a,c)};b.source="function("+(e.variable||"obj")+"){\n"+a+"}";return b};
c.chain=function(a){return c(a).chain()};var p=function(a){this._wrapped=a};c.prototype=p.prototype;var v=function(a,b){return b?c(a).chain():a};c.mixin(c);l("pop push reverse shift sort splice unshift".split(" "),function(a){var b=h[a];p.prototype[a]=function(){var c=this._wrapped;b.apply(c,arguments);var e=c.length;("shift"==a||"splice"==a)&&0===e&&delete c[0];return v(c,this._chain)}});l(["concat","join","slice"],function(a){var b=h[a];p.prototype[a]=function(){return v(b.apply(this._wrapped,arguments),
this._chain)}});p.prototype.chain=function(){this._chain=!0;return this};p.prototype.value=function(){return this._wrapped}}).call(this);(function(f){for(var a in f)if(!window[a])throw"Error: ShaderGraph requires "+f[a];})({THREE:"Three.js"});window.ShaderGraph={};ShaderGraph.getShader=function(f){var a=document.getElementById(f);return a&&a.innerText||f};
...
b,e){f.Block.Snippet.compileCall(a,b,this.node(),this.snippet,e)},fetch:function(a,b,e,f){a.include(this,b)||this.insert(a,b,f);return e.id()},outlets:function(){return f.Block.Snippet.makeOutlets(this.snippet.arguments())}});f.Block.Material=function(a,b){this.vertex=new f.Snippet(a);this.fragment=new f.Snippet(b);f.Block.call(this)};f.Block.Material.prototype=_.extend({},f.Block.prototype,{compile:function(){if(0<this.node().outputs.length)throw"Can't compile material with outputs";this.node();
var a=new f.Program;this.insert(a,"vertex",0);this.insert(a,"fragment",0);a.compile();return a},insert:function(a,b,e){f.Block.Snippet.compileCall(a,b,this.node(),this[b],e)},fetch:function(a,b,e,f){a.include(this,b)||this.insert(a,b,f);"fragment"==b&&(a.include(this,"vertex")||this.insert(a,"vertex",0));return e.id()},outlets:function(){var a=f.Block.Snippet.makeOutlets(this.vertex.arguments()),b=f.Block.Snippet.makeOutlets(this.fragment.arguments());return _.union(a,b)}});f.Block.Snippet.makeOutlets=
function(a){var b=[];_.each(a.parameters,function(a){a.meta={required:!0};a.hint=a.name.replace(/(In|Out)$/,"");a.category="parameter";b.push(a)});_.each(a.uniforms,function(a){a.meta={};a.hint=a.name.replace(/(In|Out)$/,"");a.category="uniform";a.inout=f.IN;b.push(a)});return b};f.Block.Snippet.compileCall=function(a,b,e,h,i){var g=h.arguments(),m=[];_.each(g.parameters,function(g){var h=e.get(g.name);if(g.inout==f.IN)if(h.input)h=h.input.node.owner().fetch(a,b,h.input,i+1),a.variable(b,h,g),m.push(h);
else throw console.log("Outlet",g,h),["Missing connection on outlet for "+g.name];else g.inout==f.OUT&&(h=h.id(),a.variable(b,h,g),m.push(h))});var k=[];_.each(g.uniforms,function(f){var g=e.get(f.name);g.input?(g=g.input.node.owner().fetch(a,b,g.input,i+1),a.variable(b,g,f),m.push(g),k.push(f.name)):a.external("uniform",f)});_.each(g.attributes,function(b){a.external("attribute",b)});_.each(g.varyings,function(b){a.external("varying",b)});g=["_sg",b,h.name,e.owner().index].join("_");h=h.compile(g,
k,!0);a.add(b,g,m,h,i)}})(ShaderGraph);
...
(function(f){f.Snippet=function(a){this.code=a;this.attributes=[];this.uniforms=[];this.varyings=[];this.parameters=[];this.body=this.signature="";this.parseCode(a)};f.Snippet.types={"float":"f",vec2:"v2",vec3:"v3",vec4:"v4",mat3:"m3",mat4:"m4",sampler2D:"t",samplerCube:"t"};f.Snippet.defaults={"float":0,vec2:new THREE.Vector3,vec3:new THREE.Vector3,vec4:new THREE.Vector4,mat4:new THREE.Matrix4,sampler2D:0,samplerCube:0};f.Snippet.prototype={compile:function(a,b,e){var f=this.signature.slice(),i=
[],b=b||[];_.each(this.uniforms,function(a){0<=b.indexOf(a.name)?f.push(a.signature):e||i.push(["uniform",a.signature].join(" "))});!e&&_.each(this.attributes,function(a){i.push(["attribute",a.signature].join(" "))});!e&&_.each(this.varyings,function(a){i.push(["varying",a.signature].join(" "))});a=this.body.replace(/\s*void\s+([A-Za-z0-9]+)\s*\([^\)]*\)/g,["void",a+"(",f.join(", "),")"].join(" "));i.push(a);return i.join(";\n")},arguments:function(){return{uniforms:this.uniforms,varyings:this.varyings,
attributes:this.attributes,parameters:this.parameters}},type:function(a,b){a=(f.Snippet.types[a]||"f")+(b?"v":"");return"fv"==a?"fv1":a},parseAttribute:function(a){var b=a[1];this.attributes.push({name:a[3],type:this.type(a[2],a[4]),signature:b})},parseUniform:function(a){var b=a[1],e=a[2];this.uniforms.push({name:a[3],type:this.type(e,a[4]),value:f.Snippet.defaults[e]||0,signature:b})},parseVarying:function(a){var b=a[1];this.varyings.push({name:a[3],type:this.type(a[2],a[4]),signature:b})},parseSignature:function(a){this.name=
a[1];var b=a[2].replace(/^\s*$/g,"");0==b.length?this.signature=[]:(arguments=this.signature=b.split(","),_.each(arguments,function(a){var a=/((?:(in|out|inout)\s+)?([A-Za-z0-9]+)\s+([A-Za-z0-9_]+)\s*(?:\[([^\]]+)\])?)(?:$|(?=;))/.exec(a),b=a[1];this.parameters.push({inout:{"in":f.IN,out:f.OUT,inout:f.INOUT}[a[2]||"in"],name:a[4],type:this.type(a[3],a[5]),signature:b})}.bind(this)))},parseCode:function(a){function b(a,b){if(!a.global)throw"Can't findAll non-global regexp";for(var e,f=[];e=a.exec(b);)f.push(e);
return f}var a=a.replace(/\r\n?/g,"\n").replace(/\/\/[^\n]*\n/g," ").replace(/\/\*(.|\n)*?\*\//g," "),e=b(/(?:^|;)\s*attribute\s+(([A-Za-z0-9]+)\s+([A-Za-z0-9_]+)\s*(?:\[([^\]]+)\])?)(?:$|(?=;))/g,a),f=b(/(?:^|;)\s*uniform\s+(([A-Za-z0-9]+)\s+([A-Za-z0-9_]+)\s*(?:\[([^\]]+)\])?)(?:$|(?=;))/g,a),i=b(/(?:^|;)\s*varying\s+(([A-Za-z0-9]+)\s+([[A-Za-z0-9_]+)\s*(?:\[([^\]]+)\])?)(?:$|(?=;))/g,a),g=b(/(?:^|;)\s*void\s+([A-Za-z0-9]+)\s*\(([^\)]*)\)\s*{/g,a);if(!g[0])throw"Could not parse shader snippet. Must contain a void-returning function with in/outs: "+
a;var m=a;_.each({parseAttribute:e,parseUniform:f,parseVarying:i},function(a,b){_.each(a,function(a){this[b](a);m=m.replace(a[0],"")}.bind(this))}.bind(this));m=m.replace(/^\s*;/,"");this.parseSignature(g[0]);this.body=m}}})(ShaderGraph);
...
a.link(this);outlets[b]=a;(a.inout==f.IN?_in:_out).push(a);return this},remove:function(a){var b=this._outlets,e=this.key(a),h=a.inout==f.IN?this.inputs:this.outputs;if(a.node!=this)throw"Removing outlet from wrong node.";a.disconnect();a.link(null);delete b[e];h.splice(h.indexOf(a),1);return this},connect:function(a,b,e){var f={},i={},g;g={};_.each(a.inputs,function(a){if(e||!a.input){var b=a.type,n=[b,a.hint].join("-"),s=g[b]=(g[b]||0)+1,b=[b,s].join("-");i[n]=a;f[b]=a}});g={};_.each(this.outputs,
function(a){if(!b||!a.output.length){var e=a.type,n=[e,a.hint].join("-");i[n]?i[n].connect(a):(n=g[e]=(g[e]||0)+1,e=[e,n].join("-"),f[e]&&f[e].connect(a))}});return this},disconnect:function(){_.each(this.inputs,function(a){a.disconnect()});_.each(this.outputs,function(a){a.disconnect()});return this}}})(ShaderGraph);
(function(f){f.Outlets=0;f.Outlet=function(a,b,e,h,i,g,m){if("object"==typeof a)return new f.Outlet(a.inout,a.name,a.hint,a.type,a.category,a.exposed);this.node=null;this.inout=a;this.name=b;this.hint=e||b;this.type=h;this.category=i;this.exposed=!!g;this.meta=m||{};this.index=++f.Outlets;this.input=null;this.output=[]};f.Outlet.prototype={id:function(){return["_sg",this.name,this.index].join("_")},expose:function(a){this.exposed=a},morph:function(a){this.inout=a.inout;this.name=a.name;this.type=
