...
name:b,type:f,value:e}},variable:function(a,b,f){this.variables[a][b]={name:b,type:f}},add:function(a,b,f,e,k){var g=this.calls[a][b];g?g.priority=Math.min(g.priority,k):this.calls[a][b]={name:b,args:f,code:e,priority:k}},compile:function(){_.each(this.externals,function(a){"uniform"==a.category&&(this.uniforms[a.name]={type:a.type,value:a.value})}.bind(this));_.each(["vertex","fragment"],function(a){var b=_.toArray(this.calls[a]),f=[],h=["void main() {"];_.each(this.variables[a],function(a){h.push([e.Program.types[a.type],
