...
null;h&&c.apply(b,f);p()},a));g?h=!0:l=c.apply(b,f);p();g=!0;return l}};d.debounce=function(c,a,b){var d;return function(){var f=this,e=arguments;b&&!d&&c.apply(f,e);clearTimeout(d);d=setTimeout(function(){d=null;b||c.apply(f,e)},a)}};d.once=function(c){var a=!1,b;return function(){if(a)return b;a=!0;return b=c.apply(this,arguments)}};d.wrap=function(c,a){return function(){var b=[c].concat(g.call(arguments,0));return a.apply(this,b)}};d.compose=function(){var c=arguments;return function(){for(var a=
arguments,b=c.length-1;0<=b;b--)a=[c[b].apply(this,a)];return a[0]}};d.after=function(c,a){return 0>=c?a():function(){if(1>--c)return a.apply(this,arguments)}};d.keys=I||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],f;for(f in a)d.has(a,f)&&(b[b.length]=f);return b};d.values=function(a){return d.map(a,d.identity)};d.functions=d.methods=function(a){var b=[],f;for(f in a)d.isFunction(a[f])&&b.push(f);return b.sort()};d.extend=function(a){m(g.call(arguments,1),function(b){for(var d in b)a[d]=
...
d.chain=function(a){return d(a).chain()};var o=function(a){this._wrapped=a};d.prototype=o.prototype;var u=function(a,b){return b?d(a).chain():a};d.mixin(d);m("pop push reverse shift sort splice unshift".split(" "),function(a){var b=h[a];o.prototype[a]=function(){var d=this._wrapped;b.apply(d,arguments);var f=d.length;(a=="shift"||a=="splice")&&f===0&&delete d[0];return u(d,this._chain)}});m(["concat","join","slice"],function(a){var b=h[a];o.prototype[a]=function(){return u(b.apply(this._wrapped,arguments),
...
b.start=b.start.concat(a.start);b.end=b.end.concat(a.end);return this},end:function(){var a=this.graph;this.graph=new e.Graph;this.stack=[];this.group();return a}}})(ShaderGraph);
