(function(){function e(c,a,j){if(c===a)return 0!==c||1/c==1/a;if(null==c||null==a)return c===a;c._chain&&(c=c._wrapped);a._chain&&(a=a._wrapped);if(c.isEqual&&d.isFunction(c.isEqual))return c.isEqual(a);if(a.isEqual&&d.isFunction(a.isEqual))return a.isEqual(c);var t=n.call(c);if(t!=n.call(a))return!1;switch(t){case "[object String]":return c==""+a;case "[object Number]":return c!=+c?a!=+a:0==c?1/c==1/a:c==+a;case "[object Date]":case "[object Boolean]":return+c==+a;case "[object RegExp]":return c.source==
a.source&&c.global==a.global&&c.multiline==a.multiline&&c.ignoreCase==a.ignoreCase}if("object"!=typeof c||"object"!=typeof a)return!1;for(var b=j.length;b--;)if(j[b]==c)return!0;j.push(c);var b=0,f=!0;if("[object Array]"==t){if(b=c.length,f=b==a.length)for(;b--&&(f=b in c==b in a&&e(c[b],a[b],j)););}else{if("constructor"in c!="constructor"in a||c.constructor!=a.constructor)return!1;for(var g in c)if(d.has(c,g)&&(b++,!(f=d.has(a,g)&&e(c[g],a[g],j))))break;if(f){for(g in a)if(d.has(a,g)&&!b--)break;
f=!b}}j.pop();return f}var a=this,b=a._,f={},h=Array.prototype,l=Object.prototype,g=h.slice,k=h.unshift,n=l.toString,I=l.hasOwnProperty,q=h.forEach,z=h.map,A=h.reduce,B=h.reduceRight,C=h.filter,D=h.every,E=h.some,s=h.indexOf,F=h.lastIndexOf,l=Array.isArray,J=Object.keys,u=Function.prototype.bind,d=function(c){return new p(c)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=d),exports._=d):a._=d;d.VERSION="1.3.3";var m=d.each=d.forEach=function(c,
a,j){if(null!=c)if(q&&c.forEach===q)c.forEach(a,j);else if(c.length===+c.length)for(var b=0,e=c.length;b<e&&!(b in c&&a.call(j,c[b],b,c)===f);b++);else for(b in c)if(d.has(c,b)&&a.call(j,c[b],b,c)===f)break};d.map=d.collect=function(c,a,d){var b=[];if(null==c)return b;if(z&&c.map===z)return c.map(a,d);m(c,function(c,f,e){b[b.length]=a.call(d,c,f,e)});c.length===+c.length&&(b.length=c.length);return b};d.reduce=d.foldl=d.inject=function(c,a,j,b){var f=2<arguments.length;null==c&&(c=[]);if(A&&c.reduce===
A)return b&&(a=d.bind(a,b)),f?c.reduce(a,j):c.reduce(a);m(c,function(c,d,e){f?j=a.call(b,j,c,d,e):(j=c,f=!0)});if(!f)throw new TypeError("Reduce of empty array with no initial value");return j};d.reduceRight=d.foldr=function(c,a,j,b){var f=2<arguments.length;null==c&&(c=[]);if(B&&c.reduceRight===B)return b&&(a=d.bind(a,b)),f?c.reduceRight(a,j):c.reduceRight(a);var e=d.toArray(c).reverse();b&&!f&&(a=d.bind(a,b));return f?d.reduce(e,a,j,b):d.reduce(e,a)};d.find=d.detect=function(c,a,d){var b;G(c,function(c,
f,e){if(a.call(d,c,f,e))return b=c,!0});return b};d.filter=d.select=function(c,a,d){var b=[];if(null==c)return b;if(C&&c.filter===C)return c.filter(a,d);m(c,function(c,f,e){a.call(d,c,f,e)&&(b[b.length]=c)});return b};d.reject=function(c,a,d){var b=[];if(null==c)return b;m(c,function(c,f,e){a.call(d,c,f,e)||(b[b.length]=c)});return b};d.every=d.all=function(c,a,d){var b=!0;if(null==c)return b;if(D&&c.every===D)return c.every(a,d);m(c,function(c,e,g){if(!(b=b&&a.call(d,c,e,g)))return f});return!!b};
var G=d.some=d.any=function(c,a,b){a||(a=d.identity);var e=!1;if(null==c)return e;if(E&&c.some===E)return c.some(a,b);m(c,function(c,d,g){if(e||(e=a.call(b,c,d,g)))return f});return!!e};d.include=d.contains=function(c,a){return null==c?!1:s&&c.indexOf===s?-1!=c.indexOf(a):G(c,function(c){return c===a})};d.invoke=function(c,a){var b=g.call(arguments,2);return d.map(c,function(c){return(d.isFunction(a)?a||c:c[a]).apply(c,b)})};d.pluck=function(c,a){return d.map(c,function(c){return c[a]})};d.max=function(c,
...
0;f<a;f++)b[f]=d.pluck(c,""+f);return b};d.indexOf=function(c,a,b){if(null==c)return-1;var f;if(b)return b=d.sortedIndex(c,a),c[b]===a?b:-1;if(s&&c.indexOf===s)return c.indexOf(a);b=0;for(f=c.length;b<f;b++)if(b in c&&c[b]===a)return b;return-1};d.lastIndexOf=function(c,a){if(null==c)return-1;if(F&&c.lastIndexOf===F)return c.lastIndexOf(a);for(var b=c.length;b--;)if(b in c&&c[b]===a)return b;return-1};d.range=function(c,a,b){1>=arguments.length&&(a=c||0,c=0);for(var b=arguments[2]||1,d=Math.max(Math.ceil((a-
c)/b),0),f=0,e=Array(d);f<d;)e[f++]=c,c+=b;return e};var H=function(){};d.bind=function(c,a){var b,f;if(c.bind===u&&u)return u.apply(c,g.call(arguments,1));if(!d.isFunction(c))throw new TypeError;f=g.call(arguments,2);return b=function(){if(!(this instanceof b))return c.apply(a,f.concat(g.call(arguments)));H.prototype=c.prototype;var d=new H,e=c.apply(d,f.concat(g.call(arguments)));return Object(e)===e?e:d}};d.bindAll=function(c){var a=g.call(arguments,1);0==a.length&&(a=d.functions(c));m(a,function(a){c[a]=
d.bind(c[a],c)});return c};d.memoize=function(c,a){var b={};a||(a=d.identity);return function(){var f=a.apply(this,arguments);return d.has(b,f)?b[f]:b[f]=c.apply(this,arguments)}};d.delay=function(c,a){var b=g.call(arguments,2);return setTimeout(function(){return c.apply(null,b)},a)};d.defer=function(c){return d.delay.apply(d,[c,1].concat(g.call(arguments,1)))};d.throttle=function(c,a){var b,f,e,g,h,l,q=d.debounce(function(){h=g=!1},a);return function(){b=this;f=arguments;e||(e=setTimeout(function(){e=
null;h&&c.apply(b,f);q()},a));g?h=!0:l=c.apply(b,f);q();g=!0;return l}};d.debounce=function(c,a,b){var d;return function(){var f=this,e=arguments;b&&!d&&c.apply(f,e);clearTimeout(d);d=setTimeout(function(){d=null;b||c.apply(f,e)},a)}};d.once=function(c){var a=!1,b;return function(){if(a)return b;a=!0;return b=c.apply(this,arguments)}};d.wrap=function(c,a){return function(){var b=[c].concat(g.call(arguments,0));return a.apply(this,b)}};d.compose=function(){var c=arguments;return function(){for(var a=
arguments,b=c.length-1;0<=b;b--)a=[c[b].apply(this,a)];return a[0]}};d.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};d.keys=J||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],f;for(f in a)d.has(a,f)&&(b[b.length]=f);return b};d.values=function(a){return d.map(a,d.identity)};d.functions=d.methods=function(a){var b=[],f;for(f in a)d.isFunction(a[f])&&b.push(f);return b.sort()};d.extend=function(a){m(g.call(arguments,1),function(b){for(var d in b)a[d]=
...
n.call(a)};d.isFinite=function(a){return d.isNumber(a)&&isFinite(a)};d.isNaN=function(a){return a!==a};d.isBoolean=function(a){return!0===a||!1===a||"[object Boolean]"==n.call(a)};d.isDate=function(a){return"[object Date]"==n.call(a)};d.isRegExp=function(a){return"[object RegExp]"==n.call(a)};d.isNull=function(a){return null===a};d.isUndefined=function(a){return void 0===a};d.has=function(a,b){return I.call(a,b)};d.noConflict=function(){a._=b;return this};d.identity=function(a){return a};d.times=
function(a,b,d){for(var f=0;f<a;f++)b.call(d,f)};d.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};d.result=function(a,b){if(null==a)return null;var f=a[b];return d.isFunction(f)?f.call(a):f};d.mixin=function(a){m(d.functions(a),function(b){var f=d[b]=a[b];p.prototype[b]=function(){var a=g.call(arguments);k.call(a,this._wrapped);return v(f.apply(d,a),this._chain)}})};var K=0;d.uniqueId=
function(a){var b=K++;return a?a+b:b};d.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var w=/.^/,r={"\\":"\\","'":"'",r:"\r",n:"\n",t:"\t",u2028:"\u2028",u2029:"\u2029"},x;for(x in r)r[r[x]]=x;var L=/\\|'|\r|\n|\t|\u2028|\u2029/g,M=/\\(\\|'|r|n|t|u2028|u2029)/g,y=function(a){return a.replace(M,function(a,b){return r[b]})};d.template=function(a,b,f){f=d.defaults(f||{},d.templateSettings);a="__p+='"+a.replace(L,function(a){return"\\"+r[a]}).replace(f.escape||
w,function(a,b){return"'+\n_.escape("+y(b)+")+\n'"}).replace(f.interpolate||w,function(a,b){return"'+\n("+y(b)+")+\n'"}).replace(f.evaluate||w,function(a,b){return"';\n"+y(b)+"\n;__p+='"})+"';\n";f.variable||(a="with(obj||{}){\n"+a+"}\n");var a="var __p='';var print=function(){__p+=Array.prototype.join.call(arguments, '')};\n"+a+"return __p;\n",e=new Function(f.variable||"obj","_",a);if(b)return e(b,d);b=function(a){return e.call(this,a,d)};b.source="function("+(f.variable||"obj")+"){\n"+a+"}";return b};
d.chain=function(a){return d(a).chain()};var p=function(a){this._wrapped=a};d.prototype=p.prototype;var v=function(a,b){return b?d(a).chain():a};d.mixin(d);m("pop push reverse shift sort splice unshift".split(" "),function(a){var b=h[a];p.prototype[a]=function(){var d=this._wrapped;b.apply(d,arguments);var f=d.length;("shift"==a||"splice"==a)&&0===f&&delete d[0];return v(d,this._chain)}});m(["concat","join","slice"],function(a){var b=h[a];p.prototype[a]=function(){return v(b.apply(this._wrapped,arguments),
this._chain)}});p.prototype.chain=function(){this._chain=!0;return this};p.prototype.value=function(){return this._wrapped}}).call(this);(function(e){for(i in e)if(!window[i])throw"Error: ShaderGraph requires "+e[i];})({THREE:"Three.js"});window.ShaderGraph={};ShaderGraph.getShader=function(e){var a=document.getElementById(e);return a&&a.innerText||e};
...
k.push(h);else throw console.log("Outlet",g,h),["Missing connection on outlet for "+g.name];else g.inout==e.OUT&&(h=h.id(),a.variable(b,h,g.type),k.push(h))});var n=[];_.each(g.uniforms,function(e){var g=f.get(e.name);g.input?(g=g.input.node.owner().fetch(a,b,g.input,l+1),a.variable(b,g,e.type),k.push(g),n.push(e.name)):a.external("uniform",e.name,e.type,e.value)});g=["_sg",b,h.name,f.owner().index].join("_");h=h.compile(g,n);a.add(b,g,k,h,l)}})(ShaderGraph);
