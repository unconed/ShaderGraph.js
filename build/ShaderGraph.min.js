(function(){function f(d,a,k){if(d===a)return 0!==d||1/d==1/a;if(null==d||null==a)return d===a;d._chain&&(d=d._wrapped);a._chain&&(a=a._wrapped);if(d.isEqual&&c.isFunction(d.isEqual))return d.isEqual(a);if(a.isEqual&&c.isFunction(a.isEqual))return a.isEqual(d);var b=l.call(d);if(b!=l.call(a))return!1;switch(b){case "[object String]":return d==""+a;case "[object Number]":return d!=+d?a!=+a:0==d?1/d==1/a:d==+a;case "[object Date]":case "[object Boolean]":return+d==+a;case "[object RegExp]":return d.source==
a.source&&d.global==a.global&&d.multiline==a.multiline&&d.ignoreCase==a.ignoreCase}if("object"!=typeof d||"object"!=typeof a)return!1;for(var e=k.length;e--;)if(k[e]==d)return!0;k.push(d);var e=0,h=!0;if("[object Array]"==b){if(e=d.length,h=e==a.length)for(;e--&&(h=e in d==e in a&&f(d[e],a[e],k)););}else{if("constructor"in d!="constructor"in a||d.constructor!=a.constructor)return!1;for(var g in d)if(c.has(d,g)&&(e++,!(h=c.has(a,g)&&f(d[g],a[g],k))))break;if(h){for(g in a)if(c.has(a,g)&&!e--)break;
h=!e}}k.pop();return h}var a=this,b=a._,e={},h=Array.prototype,j=Object.prototype,g=h.slice,m=h.unshift,l=j.toString,H=j.hasOwnProperty,q=h.forEach,y=h.map,z=h.reduce,A=h.reduceRight,B=h.filter,C=h.every,D=h.some,s=h.indexOf,E=h.lastIndexOf,j=Array.isArray,I=Object.keys,t=Function.prototype.bind,c=function(d){return new p(d)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=c),exports._=c):a._=c;c.VERSION="1.3.3";var n=c.each=c.forEach=function(d,
a,k){if(null!=d)if(q&&d.forEach===q)d.forEach(a,k);else if(d.length===+d.length)for(var b=0,f=d.length;b<f&&!(b in d&&a.call(k,d[b],b,d)===e);b++);else for(b in d)if(c.has(d,b)&&a.call(k,d[b],b,d)===e)break};c.map=c.collect=function(d,a,c){var b=[];if(null==d)return b;if(y&&d.map===y)return d.map(a,c);n(d,function(d,e,f){b[b.length]=a.call(c,d,e,f)});d.length===+d.length&&(b.length=d.length);return b};c.reduce=c.foldl=c.inject=function(d,a,k,b){var e=2<arguments.length;null==d&&(d=[]);if(z&&d.reduce===
z)return b&&(a=c.bind(a,b)),e?d.reduce(a,k):d.reduce(a);n(d,function(d,c,f){e?k=a.call(b,k,d,c,f):(k=d,e=!0)});if(!e)throw new TypeError("Reduce of empty array with no initial value");return k};c.reduceRight=c.foldr=function(d,a,k,b){var e=2<arguments.length;null==d&&(d=[]);if(A&&d.reduceRight===A)return b&&(a=c.bind(a,b)),e?d.reduceRight(a,k):d.reduceRight(a);var f=c.toArray(d).reverse();b&&!e&&(a=c.bind(a,b));return e?c.reduce(f,a,k,b):c.reduce(f,a)};c.find=c.detect=function(d,a,c){var b;F(d,function(d,
e,f){if(a.call(c,d,e,f))return b=d,!0});return b};c.filter=c.select=function(d,a,c){var b=[];if(null==d)return b;if(B&&d.filter===B)return d.filter(a,c);n(d,function(d,e,f){a.call(c,d,e,f)&&(b[b.length]=d)});return b};c.reject=function(d,a,c){var b=[];if(null==d)return b;n(d,function(d,e,f){a.call(c,d,e,f)||(b[b.length]=d)});return b};c.every=c.all=function(d,a,c){var b=!0;if(null==d)return b;if(C&&d.every===C)return d.every(a,c);n(d,function(d,f,h){if(!(b=b&&a.call(c,d,f,h)))return e});return!!b};
var F=c.some=c.any=function(d,a,b){a||(a=c.identity);var f=!1;if(null==d)return f;if(D&&d.some===D)return d.some(a,b);n(d,function(d,c,h){if(f||(f=a.call(b,d,c,h)))return e});return!!f};c.include=c.contains=function(d,a){return null==d?!1:s&&d.indexOf===s?-1!=d.indexOf(a):F(d,function(d){return d===a})};c.invoke=function(d,a){var b=g.call(arguments,2);return c.map(d,function(d){return(c.isFunction(a)?a||d:d[a]).apply(d,b)})};c.pluck=function(d,a){return c.map(d,function(d){return d[a]})};c.max=function(d,
a,b){if(!a&&c.isArray(d)&&d[0]===+d[0])return Math.max.apply(Math,d);if(!a&&c.isEmpty(d))return-Infinity;var e={computed:-Infinity};n(d,function(d,c,f){c=a?a.call(b,d,c,f):d;c>=e.computed&&(e={value:d,computed:c})});return e.value};c.min=function(d,a,b){if(!a&&c.isArray(d)&&d[0]===+d[0])return Math.min.apply(Math,d);if(!a&&c.isEmpty(d))return Infinity;var e={computed:Infinity};n(d,function(d,c,f){c=a?a.call(b,d,c,f):d;c<e.computed&&(e={value:d,computed:c})});return e.value};c.shuffle=function(d){var a=
[],c;n(d,function(d,b){c=Math.floor(Math.random()*(b+1));a[b]=a[c];a[c]=d});return a};c.sortBy=function(d,a,b){var e=c.isFunction(a)?a:function(d){return d[a]};return c.pluck(c.map(d,function(d,a,c){return{value:d,criteria:e.call(b,d,a,c)}}).sort(function(d,a){var c=d.criteria,b=a.criteria;return void 0===c?1:void 0===b?-1:c<b?-1:c>b?1:0}),"value")};c.groupBy=function(d,a){var b={},e=c.isFunction(a)?a:function(d){return d[a]};n(d,function(d,a){var c=e(d,a);(b[c]||(b[c]=[])).push(d)});return b};c.sortedIndex=
function(d,a,b){b||(b=c.identity);for(var e=0,f=d.length;e<f;){var h=e+f>>1;b(d[h])<b(a)?e=h+1:f=h}return e};c.toArray=function(d){return!d?[]:c.isArray(d)||c.isArguments(d)?g.call(d):d.toArray&&c.isFunction(d.toArray)?d.toArray():c.values(d)};c.size=function(d){return c.isArray(d)?d.length:c.keys(d).length};c.first=c.head=c.take=function(d,a,c){return null!=a&&!c?g.call(d,0,a):d[0]};c.initial=function(d,a,c){return g.call(d,0,d.length-(null==a||c?1:a))};c.last=function(d,a,c){return null!=a&&!c?
g.call(d,Math.max(d.length-a,0)):d[d.length-1]};c.rest=c.tail=function(d,a,c){return g.call(d,null==a||c?1:a)};c.compact=function(d){return c.filter(d,function(d){return!!d})};c.flatten=function(d,a){return c.reduce(d,function(d,b){if(c.isArray(b))return d.concat(a?b:c.flatten(b));d[d.length]=b;return d},[])};c.without=function(d){return c.difference(d,g.call(arguments,1))};c.uniq=c.unique=function(d,a,b){b=b?c.map(d,b):d;var e=[];3>d.length&&(a=!0);c.reduce(b,function(b,f,k){if(a?c.last(b)!==f||
!b.length:!c.include(b,f))b.push(f),e.push(d[k]);return b},[]);return e};c.union=function(){return c.uniq(c.flatten(arguments,!0))};c.intersection=c.intersect=function(d){var a=g.call(arguments,1);return c.filter(c.uniq(d),function(d){return c.every(a,function(a){return 0<=c.indexOf(a,d)})})};c.difference=function(d){var a=c.flatten(g.call(arguments,1),!0);return c.filter(d,function(d){return!c.include(a,d)})};c.zip=function(){for(var d=g.call(arguments),a=c.max(c.pluck(d,"length")),b=Array(a),e=
0;e<a;e++)b[e]=c.pluck(d,""+e);return b};c.indexOf=function(d,a,b){if(null==d)return-1;var e;if(b)return b=c.sortedIndex(d,a),d[b]===a?b:-1;if(s&&d.indexOf===s)return d.indexOf(a);b=0;for(e=d.length;b<e;b++)if(b in d&&d[b]===a)return b;return-1};c.lastIndexOf=function(d,a){if(null==d)return-1;if(E&&d.lastIndexOf===E)return d.lastIndexOf(a);for(var b=d.length;b--;)if(b in d&&d[b]===a)return b;return-1};c.range=function(d,a,b){1>=arguments.length&&(a=d||0,d=0);b=arguments[2]||1;for(var c=Math.max(Math.ceil((a-
d)/b),0),e=0,f=Array(c);e<c;)f[e++]=d,d+=b;return f};var G=function(){};c.bind=function(a,b){var e,f;if(a.bind===t&&t)return t.apply(a,g.call(arguments,1));if(!c.isFunction(a))throw new TypeError;f=g.call(arguments,2);return e=function(){if(!(this instanceof e))return a.apply(b,f.concat(g.call(arguments)));G.prototype=a.prototype;var c=new G,h=a.apply(c,f.concat(g.call(arguments)));return Object(h)===h?h:c}};c.bindAll=function(a){var b=g.call(arguments,1);0==b.length&&(b=c.functions(a));n(b,function(b){a[b]=
c.bind(a[b],a)});return a};c.memoize=function(a,b){var e={};b||(b=c.identity);return function(){var f=b.apply(this,arguments);return c.has(e,f)?e[f]:e[f]=a.apply(this,arguments)}};c.delay=function(a,b){var c=g.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};c.defer=function(a){return c.delay.apply(c,[a,1].concat(g.call(arguments,1)))};c.throttle=function(a,b){var e,f,h,g,j,m,q=c.debounce(function(){j=g=!1},b);return function(){e=this;f=arguments;h||(h=setTimeout(function(){h=
null;j&&a.apply(e,f);q()},b));g?j=!0:m=a.apply(e,f);q();g=!0;return m}};c.debounce=function(a,b,c){var e;return function(){var f=this,h=arguments;c&&!e&&a.apply(f,h);clearTimeout(e);e=setTimeout(function(){e=null;c||a.apply(f,h)},b)}};c.once=function(a){var b=!1,c;return function(){if(b)return c;b=!0;return c=a.apply(this,arguments)}};c.wrap=function(a,b){return function(){var c=[a].concat(g.call(arguments,0));return b.apply(this,c)}};c.compose=function(){var a=arguments;return function(){for(var b=
arguments,c=a.length-1;0<=c;c--)b=[a[c].apply(this,b)];return b[0]}};c.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};c.keys=I||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],e;for(e in a)c.has(a,e)&&(b[b.length]=e);return b};c.values=function(a){return c.map(a,c.identity)};c.functions=c.methods=function(a){var b=[],e;for(e in a)c.isFunction(a[e])&&b.push(e);return b.sort()};c.extend=function(a){n(g.call(arguments,1),function(b){for(var c in b)a[c]=
b[c]});return a};c.pick=function(a){var b={};n(c.flatten(g.call(arguments,1)),function(c){c in a&&(b[c]=a[c])});return b};c.defaults=function(a){n(g.call(arguments,1),function(b){for(var c in b)null==a[c]&&(a[c]=b[c])});return a};c.clone=function(a){return!c.isObject(a)?a:c.isArray(a)?a.slice():c.extend({},a)};c.tap=function(a,b){b(a);return a};c.isEqual=function(a,b){return f(a,b,[])};c.isEmpty=function(a){if(null==a)return!0;if(c.isArray(a)||c.isString(a))return 0===a.length;for(var b in a)if(c.has(a,
...
function(a,b,c){for(var e=0;e<a;e++)b.call(c,e)};c.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};c.result=function(a,b){if(null==a)return null;var e=a[b];return c.isFunction(e)?e.call(a):e};c.mixin=function(a){n(c.functions(a),function(b){var e=c[b]=a[b];p.prototype[b]=function(){var a=g.call(arguments);m.call(a,this._wrapped);return u(e.apply(c,a),this._chain)}})};var J=0;c.uniqueId=
function(a){var b=J++;return a?a+b:b};c.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var v=/.^/,r={"\\":"\\","'":"'",r:"\r",n:"\n",t:"\t",u2028:"\u2028",u2029:"\u2029"},w;for(w in r)r[r[w]]=w;var K=/\\|'|\r|\n|\t|\u2028|\u2029/g,L=/\\(\\|'|r|n|t|u2028|u2029)/g,x=function(a){return a.replace(L,function(a,b){return r[b]})};c.template=function(a,b,e){e=c.defaults(e||{},c.templateSettings);a="__p+='"+a.replace(K,function(a){return"\\"+r[a]}).replace(e.escape||
...
c.chain=function(a){return c(a).chain()};var p=function(a){this._wrapped=a};c.prototype=p.prototype;var u=function(a,b){return b?c(a).chain():a};c.mixin(c);n("pop push reverse shift sort splice unshift".split(" "),function(a){var b=h[a];p.prototype[a]=function(){var c=this._wrapped;b.apply(c,arguments);var e=c.length;("shift"==a||"splice"==a)&&0===e&&delete c[0];return u(c,this._chain)}});n(["concat","join","slice"],function(a){var b=h[a];p.prototype[a]=function(){return u(b.apply(this._wrapped,arguments),
this._chain)}});p.prototype.chain=function(){this._chain=!0;return this};p.prototype.value=function(){return this._wrapped}}).call(this);(function(f){for(var a in f)if(!window[a])throw"Error: ShaderGraph requires "+f[a];})({THREE:"Three.js"});window.ShaderGraph={};ShaderGraph.getShader=function(f){var a=document.getElementById(f);return a&&(a.innerText||a.textContent)||f};
(function(f){f.Block=function(a){a=a||new f.Node;this.node(a);this.children=[];this.parent=null;this.properties={};this.index=++f.Block.index;this.refresh()};f.Block.index=0;f.Block.prototype={node:function(a){return void 0!==a?(this._node=a,this):this._node},refresh:function(){this._node.owner(this);this._node.outlets(this.outlets())},fetch:function(){},id:function(a,b,e,h){if(e.meta.inout){var j=e.node.get(e.name,f.IN).input;if(j)return j.node.owner().fetch(a,b,j,h+1)}return e.id()}};f.Block.Snippet=
...
a.inout=f.IN;b.push(a)});return a.outlets=b};f.Block.Snippet.compileCall=function(a,b,e,h,j){var g=h.arguments(),m=[];_.each(g.parameters,function(g){var h=e.get(g.name,g.inout==f.INOUT?f.IN:g.inout);if(g.inout==f.IN||g.inout==f.INOUT)if(h.input)h=h.input.node.owner().fetch(a,b,h.input,j+1),a.variable(b,h,g),m.push(h);else throw console.log("Outlet",g,input),["Missing connection on outlet for "+g.name];else g.inout==f.OUT&&(h=h.id(),a.variable(b,h,g),m.push(h))});var l=[];_.each(g.uniforms,function(f){var g=
e.get(f.name);g.input?(g=g.input.node.owner().fetch(a,b,g.input,j+1),a.variable(b,g,f),m.push(g),l.push(f.name)):a.external("uniform",f)});_.each(g.attributes,function(b){a.external("attribute",b)});_.each(g.varyings,function(b){a.external("varying",b)});g=["_sg",b,h.name,e.owner().index].join("_");h=h.compile(g,l,!0);a.add(b,g,m,h,j)}})(ShaderGraph);
...
var b=this.stack[0];_.each(b.end,function(b){b.connect(a)});b.start.length||(b.start=[a]);b.end=[a];return this},prepend:function(a){a.graph||this.graph.add(a);var b=this.stack[0];_.each(b.start,function(b){a.connect(b)});b.end.length||(b.end=[a]);b.start=[a];return this},group:function(){this.stack.unshift({start:[],end:[]});this.stack.unshift({start:[],end:[]});return this},pass:function(){this.stack[0].start.push(null);return this},next:function(){var a=this.stack.shift(),b=this.stack[0];b.start=
b.start.concat(a.start);b.end=b.end.concat(a.end);this.stack.unshift({start:[],end:[]});return this},combine:function(){if(2>=this.stack.length)throw"Popping factory stack too far.";this.next();this.stack.shift();var a=this.stack.shift(),b=this.stack[0];a.start.length&&(_.each(a.start,function(e){e?_.each(b.end,function(a){a.connect(e,!0)}):a.end=a.end.concat(b.end)}),b.end=a.end);return this},end:function(){var a=this.graph;this.graph=new f.Graph;this.stack=[];this.group();a&&(a.compile=function(){return a.tail().owner().compile()});
return a}}})(ShaderGraph);
...
b);this.externals[b.name]=b},variable:function(a,b,e){e=_.extend({},e,{name:b});this.variables[a][b]=e},add:function(a,b,e,f,j){var g=this.calls[a][b];g?g.priority=Math.min(g.priority,j):this.calls[a][b]={name:b,args:e,code:f,priority:j}},compile:function(){_.each(this.externals,function(a){"uniform"==a.category&&(this.uniforms[a.name]={type:a.type,value:a.value});"attribute"==a.category&&(this.attributes[a.name]={type:a.type,value:[]})}.bind(this));_.each(["vertex","fragment"],function(a){var b=
[];_.each(this.externals,function(e){"attribute"==e.category&&"fragment"==a||b.push([e.category,e.signature,";"].join(" "))}.bind(this));var b=b.join("\n"),e=_.toArray(this.calls[a]),h=[b],j=["void main() {"];_.each(this.variables[a],function(a){j.push([f.Program.types[a.type],a.name,";"].join(" "))});e.sort(function(a,b){return b.priority-a.priority});_.each(e,function(a){h.push(a.code);j.push([a.name,"(",a.args.join(","),");"].join(""))});j.push("}");this[a+"Shader"]=[h.join("\n"),j.join("\n")].join("\n")}.bind(this));
...
samplerCube:0};f.Snippet.prototype={compile:function(a,b,e){var f=this.signature.slice(),j=[];b=b||[];_.each(this.uniforms,function(a){0<=b.indexOf(a.name)?f.push(a.signature):e||j.push(["uniform",a.signature].join(" "))});!e&&_.each(this.attributes,function(a){j.push(["attribute",a.signature].join(" "))});!e&&_.each(this.varyings,function(a){j.push(["varying",a.signature].join(" "))});a=this.body.replace(/\s*void\s+([A-Za-z0-9]+)\s*\([^\)]*\)/g,["void",a+"(",f.join(", "),")"].join(" "));j.push(a);
...
b){if(!a.global)throw"Can't findAll non-global regexp";for(var e,f=[];e=a.exec(b);)f.push(e);return f}a=a.replace(/\r\n?/g,"\n").replace(/\/\/[^\n]*\n/g," ").replace(/\/\*(.|\n)*?\*\//g," ");var e=b(/(?:^|;)\s*attribute\s+(([A-Za-z0-9]+)\s+([A-Za-z0-9_]+)\s*(?:\[([^\]]+)\])?)(?:$|(?=;))/g,a),f=b(/(?:^|;)\s*uniform\s+(([A-Za-z0-9]+)\s+([A-Za-z0-9_]+)\s*(?:\[([^\]]+)\])?)(?:$|(?=;))/g,a),j=b(/(?:^|;)\s*varying\s+(([A-Za-z0-9]+)\s+([[A-Za-z0-9_]+)\s*(?:\[([^\]]+)\])?)(?:$|(?=;))/g,a),g=b(/(?:^|;)\s*void\s+([A-Za-z0-9]+)\s*\(([^\)]*)\)\s*{/g,
a);if(!g[0])throw"Could not parse shader snippet. Must contain a void-returning function with in/outs: "+a;var m=a;_.each({parseAttribute:e,parseUniform:f,parseVarying:j},function(a,b){_.each(a,function(a){this[b](a);m=m.replace(a[0],"")}.bind(this))}.bind(this));m=m.replace(/^\s*;/,"");this.parseSignature(g[0]);this.body=m}}})(ShaderGraph);
