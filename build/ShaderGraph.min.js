...
0;e<a;e++)b[e]=c.pluck(d,""+e);return b};c.indexOf=function(d,a,b){if(null==d)return-1;var e;if(b)return b=c.sortedIndex(d,a),d[b]===a?b:-1;if(s&&d.indexOf===s)return d.indexOf(a);b=0;for(e=d.length;b<e;b++)if(b in d&&d[b]===a)return b;return-1};c.lastIndexOf=function(d,a){if(null==d)return-1;if(E&&d.lastIndexOf===E)return d.lastIndexOf(a);for(var c=d.length;c--;)if(c in d&&d[c]===a)return c;return-1};c.range=function(d,a,c){1>=arguments.length&&(a=d||0,d=0);c=arguments[2]||1;for(var b=Math.max(Math.ceil((a-
d)/c),0),e=0,f=Array(b);e<b;)f[e++]=d,d+=c;return f};var G=function(){};c.bind=function(d,a){var b,e;if(d.bind===t&&t)return t.apply(d,g.call(arguments,1));if(!c.isFunction(d))throw new TypeError;e=g.call(arguments,2);return b=function(){if(!(this instanceof b))return d.apply(a,e.concat(g.call(arguments)));G.prototype=d.prototype;var c=new G,f=d.apply(c,e.concat(g.call(arguments)));return Object(f)===f?f:c}};c.bindAll=function(d){var a=g.call(arguments,1);0==a.length&&(a=c.functions(d));n(a,function(a){d[a]=
c.bind(d[a],d)});return d};c.memoize=function(a,b){var e={};b||(b=c.identity);return function(){var f=b.apply(this,arguments);return c.has(e,f)?e[f]:e[f]=a.apply(this,arguments)}};c.delay=function(a,c){var b=g.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},c)};c.defer=function(a){return c.delay.apply(c,[a,1].concat(g.call(arguments,1)))};c.throttle=function(a,b){var e,f,g,h,j,m,q=c.debounce(function(){j=h=!1},b);return function(){e=this;f=arguments;g||(g=setTimeout(function(){g=
null;j&&a.apply(e,f);q()},b));h?j=!0:m=a.apply(e,f);q();h=!0;return m}};c.debounce=function(a,c,b){var e;return function(){var f=this,g=arguments;b&&!e&&a.apply(f,g);clearTimeout(e);e=setTimeout(function(){e=null;b||a.apply(f,g)},c)}};c.once=function(a){var c=!1,b;return function(){if(c)return b;c=!0;return b=a.apply(this,arguments)}};c.wrap=function(a,c){return function(){var b=[a].concat(g.call(arguments,0));return c.apply(this,b)}};c.compose=function(){var a=arguments;return function(){for(var c=
arguments,b=a.length-1;0<=b;b--)c=[a[b].apply(this,c)];return c[0]}};c.after=function(a,c){return 0>=a?c():function(){if(1>--a)return c.apply(this,arguments)}};c.keys=I||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],e;for(e in a)c.has(a,e)&&(b[b.length]=e);return b};c.values=function(a){return c.map(a,c.identity)};c.functions=c.methods=function(a){var b=[],e;for(e in a)c.isFunction(a[e])&&b.push(e);return b.sort()};c.extend=function(a){n(g.call(arguments,1),function(b){for(var c in b)a[c]=
b[c]});return a};c.pick=function(a){var b={};n(c.flatten(g.call(arguments,1)),function(c){c in a&&(b[c]=a[c])});return b};c.defaults=function(a){n(g.call(arguments,1),function(b){for(var c in b)null==a[c]&&(a[c]=b[c])});return a};c.clone=function(a){return!c.isObject(a)?a:c.isArray(a)?a.slice():c.extend({},a)};c.tap=function(a,c){c(a);return a};c.isEqual=function(a,c){return f(a,c,[])};c.isEmpty=function(a){if(null==a)return!0;if(c.isArray(a)||c.isString(a))return 0===a.length;for(var b in a)if(c.has(a,
...
var e=a.arguments();_.each(e.parameters,function(a){a.meta={required:!0};a.hint=a.name.replace(/(In|Out)$/,"");a.category="parameter";b.push(a)});_.each(e.uniforms,function(a){a.meta={};a.hint=a.name.replace(/(In|Out)$/,"");a.category="uniform";a.inout=f.IN;b.push(a)});return a.outlets=b};f.Block.Snippet.compileCall=function(a,b,e,h,j){var g=h.arguments(),m=[];_.each(g.parameters,function(g){var h=e.get(g.name);if(g.inout==f.IN)if(h.input)h=h.input.node.owner().fetch(a,b,h.input,j+1),a.variable(b,
h,g),m.push(h);else throw console.log("Outlet",g,h),["Missing connection on outlet for "+g.name];else g.inout==f.OUT&&(h=h.id(),a.variable(b,h,g),m.push(h))});var l=[];_.each(g.uniforms,function(f){var g=e.get(f.name);g.input?(g=g.input.node.owner().fetch(a,b,g.input,j+1),a.variable(b,g,f),m.push(g),l.push(f.name)):a.external("uniform",f)});_.each(g.attributes,function(b){a.external("attribute",b)});_.each(g.varyings,function(b){a.external("varying",b)});g=["_sg",b,h.name,e.owner().index].join("_");
h=h.compile(g,l,!0);a.add(b,g,m,h,j)}})(ShaderGraph);
